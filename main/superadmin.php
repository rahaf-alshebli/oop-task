...
<section id="home" class="homeContainer">
        <div class="welcomeContainer">
            ...
            <?php 
                ...
                $fetchDetailsAll = $conn->connection->query("SELECT * FROM user WHERE role NOT IN ('Super admin')");
                ...
                $fetchDetails = $conn->connection->query("SELECT * FROM user where role = 'Admin'");
            ...
            <?php 
                if(isset($_GET['edit']))
                {
                    ...
                    $dataToEdit = $conn->connection->query("SELECT * FROM user WHERE id = '$editId'");
            ...
            <?php 
                if(isset($_GET['delete']))
                {
                    ...
                    $DELETE = $conn->connection->query("DELETE FROM user WHERE id = '$deleteID'");
                    ...
                    else
                    {
                        ?>
                        <script>
                            alert("Error Deleting record: ".<?php mysqli_error($conn->connection)?>);
                            window.location.href = "index.php";
                        </script>
                        <?php
                    }
            ...
            <?php 
                if(isset($_GET['editId']))
                {
                    ...
                    {
                        $UPDATE = $conn->connection->query("UPDATE user SET firstname = '$ename', email = '$emailEdit', password = '$passEdit', date_created = '$dateCreatedEdit', date_lastLogged = '$lastLoggedEdit', salary = '$salary', role = '$role' WHERE id = '$eId'");
                        ...
                        else
                        {
                            ?>
                            <script>
                                alert("Error Updating record: ".<?php mysqli_error($conn->connection)?>);
                                window.location.href = "superadmin.php";
                            </script>
                            <?php
                        }
